<nav id="mySidenav" class="sidenav" role="navigation" aria-label="hlavni navigace">
    ...
    <li><a href="kdojsem.php">Kdo jsem</a></li>
    <li><a href="tadyjsem.php">Díky komu tady jsem</a></li>
    <li class="sideButt"><a href="#">Co halím, když jsem</a></li>
    <div class="supSidenav">
        <li><a href="vybaveni.php">Vybavení světnice</a></li>
        <li><a href="cojeslyset.php">Co je slyšet</a></li>
    </div>
...
<div id="mySidenavButton" class="mySidenavButt" onclick="openNav()">
    &#9776;
</div>
